...
function ConsentPage({ onNavigate }) {
  return (
    <LegalPageLayout title="Согласие на обработку персональных данных" subtitle="Редакция от 13 мая 2026 года" onNavigate={onNavigate}>
      ...
      <LegalSection title="6. Правила публикации контента">
        Публикуя посты, комментарии, медиафайлы, статус профиля и иные материалы, пользователь подтверждает, что их размещение и распространение не нарушает законодательство Российской Федерации, права и законные интересы третьих лиц. Пользователь должен иметь необходимые права, разрешения и согласия на публикацию таких материалов.
        <br /><br />
        В UniMeow запрещено размещать материалы, распространение которых запрещено или ограничено законом, включая призывы к насилию, массовым беспорядкам, экстремистской или террористической деятельности; материалы, возбуждающие ненависть или вражду либо унижающие достоинство человека или группы лиц; угрозы, клевету, оскорбления, порнографические материалы, рекламу запрещенных товаров и услуг; чужие персональные данные без законного основания; объекты авторских и смежных прав без разрешения правообладателя или иного законного основания.
        <br /><br />
        UniMeow вправе ограничить доступ к незаконному или нарушающему правила контенту, удалить такой контент, ограничить функции аккаунта или заблокировать пользователя. Если это требуется законом, сведения о нарушении могут быть переданы уполномоченным органам.
      </LegalSection>

      <LegalSection title="7. Отказ от ответственности">
        UniMeow является информационной площадкой для общения и публикации пользовательского контента. Материалы пользователей не являются официальными заявлениями вузов, образовательной, юридической, медицинской, финансовой или иной профессиональной консультацией. Пользователь самостоятельно отвечает за достоверность размещаемых сведений, законность публикуемых материалов, соблюдение прав третьих лиц и последствия раскрытия информации. В пределах, допускаемых законом, UniMeow не несет ответственности за решения, принятые на основе пользовательского контента, а также за временную недоступность сервиса, технические ошибки или потерю доступа к отдельным функциям.
      </LegalSection>

      <LegalSection title="8. Срок действия и отзыв">
