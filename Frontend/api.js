...
(function () {
  ...
  const M = {
    ...
    createPost: `mutation($input:CreatePostInput!,$clientRequestId:String) { createPost(input:$input,clientRequestId:$clientRequestId) { id content authorId mediaUrls likesCount commentsCount likedByMe createdAt updatedAt universityId facultyId programId } }`,
