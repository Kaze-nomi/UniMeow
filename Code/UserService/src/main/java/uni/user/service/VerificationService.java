...
public class VerificationService {
    ...
    public void sendCode(UUID userId, String universityEmail) {
        ...
        domainRepository.findByDomain(domain)
                .orElseThrow(() -> new UnknownDomainException(
                        "Domain '" + domain + "' is not a registered university domain"
                ));

        userRepository.findAll().stream()
                .filter(u -> universityEmail.equals(u.getEmailUniversity())
        ...
        verifyRepository.save(EmailVerificationCode.builder()
                .userId(userId)
